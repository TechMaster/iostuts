...
class RESTSecureTabBar: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        publicRESTVC.tabBarItem = UITabBarItem(title: "Gái ngoan", image: UIImage(named: "gaingoan"), tag: 1)
        secureRESTVC.tabBarItem = UITabBarItem(title: "Gái xinh", image: UIImage(named: "gainganh"), tag: 2)
